...
Step 5: [Deploy the IoT Services Application to the OpenShift Cloud](#deploy-the-iot-services-app-to-openshift) or [Deploy the IoT Services Application to the Azure Cloud](#deploy-the-iot-services-app-to-azure)

Step 6: [Build and configure the IoT Reporting Application](#build-the-iot-reporting-app)

Step 7: [Deploy the IoT Reporting Application to the OpenShift Cloud](#deploy-the-iot-reporting-app-to-openshift) or [Deploy the IoT Reporting Application to the Azure Cloud](#deploy-the-iot-reporting-app-to-azure)
