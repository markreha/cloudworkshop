...
What's New
--------
- 06-08-2018: Updated Reporting Reference Application to use Plotly and jQuery DataTable.
...
2) Laravel PHP, LavaCharts, Plotly, jQuery DataTable, and Guzzle. These technologies and frameworks will be used to build the IoT Reporting application.
